    ...
    class ScannerUtil3 {
        ...
        unsafe struct MapPtr {
            ...
            public char Map( char wch ) {
                ...
                wch &= (char)_offsets[ idx ];
                return (char)( _offsets[ idx + 1 + ( wch & 0xf ) ] ^ wch );
            }
#endif
            ...
            public ReadOnlySpan<char> GetComposite( char value, int size ) {
                ...
                while ( length > 0 ) {
                    ...
                    if ( c == 0 ) {
                        var ptr = _compositeData + index[ mid ].Offset;
        ...
        public static string Normalize( string text ) {
            ...
            foreach ( char c in text ) {
                ...
                if ( other < 32 ) {
                    if ( other != 0 ) {
                        if ( other < 10 ) {
                            var span = _uMap.GetComposite( c, other );
                            b.Append( span );
                        }
                    }
                } else {
