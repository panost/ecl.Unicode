...
namespace ecl.Unicode {
	/// <summary>
	/// ISO 15924 Writing system (script)
	/// </summary>
	public enum WritingScript : short {
		Undefined = 0,
		...
		/// <para>'Kitl'</para>
		/// </summary>
		KhitanLargeScript = 505,
		
		/// <summary>
		/// Khitan small script
		/// <para>'Kits'</para>
		/// </summary>
		KhitanSmallScript = 288,
		...
		/// <para>'Latf'</para>
		/// </summary>
		LatinFrakturVariant = 217,
		
		/// <summary>
		/// Latin (Gaelic variant)
		/// <para>'Latg'</para>
		/// </summary>
		LatinGaelicVariant = 216,
		...
		/// <para>'Qabx'</para>
		/// </summary>
		ReservedForPrivateUseEnd = 949,
		
		/// <summary>
		/// Reserved for private use (start)
		/// <para>'Qaaa'</para>
		/// </summary>
		ReservedForPrivateUseStart = 900,
